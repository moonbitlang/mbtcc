...
direct_abstract_declarator
	...
	| '[' ']'
	| '[' '*' ']'
	| '[' STATIC type_qualifier_list constant_expression ']'
	| '[' STATIC assignment_expression ']'
	| '[' type_qualifier_list STATIC constant_expression ']'
	| '[' type_qualifier_list constant_expression ']'
	| '[' type_qualifier_list ']'
	| '[' assignment_expression ']'
	| direct_abstract_declarator '[' ']'
	| direct_abstract_declarator '[' '*' ']'
	| direct_abstract_declarator '[' STATIC type_qualifier_list constant_expression ']'
	| direct_abstract_declarator '[' STATIC constant_expression ']'
	| direct_abstract_declarator '[' type_qualifier_list constant_expression ']'
	| direct_abstract_declarator '[' type_qualifier_list STATIC constant_expression ']'
